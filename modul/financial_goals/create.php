...
<head>
    ...
    <title>Buat Tujuan Keuangan - FinSet</title>
    ...
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            ...
            <div class="widget-card">
                ...
                <h1>Buat Tujuan Keuangan Baru ✏️</h1>
                ...
                <form action="process.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_tujuan" id="nama_tujuan" required placeholder="Contoh: Dana Darurat, DP Rumah">
                    </div>

                    <div class="form-group">
                        <label for="total_target">Target Dana (Rp):</label>
                        <input type="number" name="total_target" id="total_target" step="1" required placeholder="Contoh: 10000000">
                    </div>

                    <div class="form-group">
                        <label for="tanggal_target">Target Tanggal:</label>
                        <input type="date" name="tanggal_target" id="tanggal_target" required min="<?= date('Y-m-d') ?>"> </div>

                    <input type="hidden" name="status" value="Belum Tercapai">

                    <button type="submit" class="btn btn-success">Simpan Tujuan</button>
                </form>
