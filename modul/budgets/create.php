...
<head>
    ...
    <title>Buat Anggaran - FinSet</title>
    ...
    <style>
        ...
        .sidebar-nav a.active {
            /* Kelas 'active' untuk halaman saat ini */
            background-color: #374151;
            color: var(--sidebar-text-hover);
        }

        .sidebar-nav a.active-dashboard {
            /* Warna khusus untuk dashboard */
            background-color: var(--primary-color);
            color: var(--sidebar-text-hover);
        }
        ...
        /* Widget Card Style (Dipakai untuk bungkus tabel/form) */
        .widget-card {
        ...
        /* Penyesuaian Tabel agar lebih modern */
        table {
            border: none;
            /* Hapus border tabel default */
            border-radius: 0;
            /* Hapus radius jika dibungkus card */
            box-shadow: none;
            /* Hapus shadow jika dibungkus card */
            width: 100%;
            /* Pastikan tabel penuh */
            border-collapse: collapse;
            /* Hapus spasi antar sel */
            margin-top: 0;
            /* Reset margin jika dibungkus card */
        }
        ...
        /* Penyesuaian Form agar lebih modern */
        .form-group label {
            color: #495057;
            display: block;
            margin-bottom: 8px;
        ...
        /* Style untuk pesan notifikasi (tambahkan jika belum ada di style.css global) */
        .message.warning {
    ...
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            ...
            <div class="widget-card">
                ...
                <h1>Buat Anggaran Bulanan Baru ✏️</h1>
                ...
                <form action="process.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="jumlah_anggaran" id="jumlah_anggaran" step="1" required placeholder="Contoh: 500000">
                    </div>

                    <div class="form-group">
                        <label for="bulan">Bulan (1-12):</label>
                        <input type="number" name="bulan" id="bulan" min="1" max="12" value="<?= date('n') ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="tahun">Tahun:</label>
                        <input type="number" name="tahun" id="tahun" min="2000" max="<?= date('Y') + 5 ?>" value="<?= date('Y') ?>" required>
                    </div>

                    <button type="submit" class="btn btn-success">Simpan Anggaran</button>
                </form>
