...
<head>
    ...
    <title>Catat Utang - FinSet</title>
    ...
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            <div class="widget-card">
                <h1>Catat Utang Baru 📝</h1>
                <p style="margin-top: -20px; margin-bottom: 20px;"><a href="read.php" class="btn btn-primary"> &lt;-- Kembali ke Daftar Utang</a></p>
                ...
                <form action="process.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="jumlah_utang" id="jumlah_utang" step="1" required placeholder="Contoh: 1000000">
                    </div>
